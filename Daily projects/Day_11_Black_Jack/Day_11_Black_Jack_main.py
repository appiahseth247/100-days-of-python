...
# Day 11 Capstone Project - Black Jack Game
"""
############### Blackjack Project #####################
...
import random
import os  # from replit import clear


# All functions must be defined on the very top of the code. So all steps that requires function definition has been
# moved to the top here.
# Hint 4: Create a deal_card() function that uses the List below to *return* a random card.
def deal_card():
    """Selects a random card from the list of cards"""
    cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
...
# If you and the computer are both over 21, you lose.
...
def compare(us, cs):
    """Takes the scores of user (us) and computer (cs), compares them and tells the winner or loser or drawn game"""
    if us > 21 and cs > 21:
        return "Your score is over 21! You lose 😤"
    if us == cs:
        return "You and computer have the same score. It is a draw"
    elif cs == 0:
        return "You lose"
    elif us == 0:
        print("You win")
        ...
        return "computer's score is over 21! You win 😃"
    elif us > cs:
        return "You win"
    elif cs > us:
        return "You lose"
...
def blackjack():
    ...
    for n in range(2):  # How to repeat a function multiple times
...
# of blackjack and show the logo from art.py. should_continue = True while should_continue: restart = input("Do you
# want to restart the game? Type 'y' or 'n'") if restart == "y": os.system('cls') blackjack() elif restart == "n":
# os.system('cls') should_continue = False print("Thanks for playing my games") blackjack()
